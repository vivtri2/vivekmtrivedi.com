  ...
  return (
    <section name="home" className="w-full bg-[#0a192f] font-sans pt-[150px] pb-[100px] px-6 sm:px-8">
      <div className="max-w-[1000px] mx-auto">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-[#8892b0]" data-aos="fade-up" data-aos-delay="200">
          Building Data-Driven AI Solutions, from Cloud to Hardware
        </h2>

        <p className="py-5 max-w-[700px] text-[#8892b0]" data-aos="fade-up" data-aos-delay="300">
          Solutions Architect, Data Engineer & AI Specialist | Bridging Tech, Business, and Human Impact
        </p>
